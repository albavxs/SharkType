...
const dict: Record<string, Record<Locale, string>> = {
  ...
  profileBio: { pt: 'Bio', en: 'Bio' },
  profileBioPlaceholder: {
    pt: 'Escreva algo curto sobre voce, sua stack ou o que anda praticando.',
    en: 'Write a short line about yourself, your stack, or what you are practicing.',
  },
  profileEditing: { pt: 'Editar perfil', en: 'Edit profile' },
  profileDoneEditing: { pt: 'Fechar editor', en: 'Close editor' },
  ...
  feedFollowTitle: { pt: 'começou a seguir', en: 'started following' },
  feedManualPostTitle: { pt: 'publicou no feed', en: 'posted to the feed' },
  feedCategoryRankedTip: { pt: 'dica de ranked', en: 'ranked tip' },
  feedCategoryLanguageFact: { pt: 'curiosidade de linguagem', en: 'language fact' },
  feedCategoryAnnouncement: { pt: 'aviso', en: 'announcement' },
  feedComposerTitle: { pt: 'Postagem manual', en: 'Manual post' },
  feedComposerSubtitle: { pt: 'Publique dicas, curiosidades ou avisos no feed global.', en: 'Publish tips, facts, or announcements to the global feed.' },
  feedComposerCategory: { pt: 'Categoria', en: 'Category' },
  feedComposerPostTitle: { pt: 'Título', en: 'Title' },
  feedComposerBody: { pt: 'Texto', en: 'Body' },
  feedComposerBodyPlaceholder: { pt: 'Escreva a postagem que vai aparecer no feed.', en: 'Write the post that will appear in the feed.' },
  feedComposerPublish: { pt: 'Publicar no feed', en: 'Publish to feed' },
  feedComposerSuccess: { pt: 'Postagem publicada com sucesso.', en: 'Post published successfully.' },
  feedFollowingRailTitle: { pt: 'Seguindo agora', en: 'Following now' },
  feedFollowingRailHint: {
    pt: 'Veja a atividade mais recente das pessoas que você segue.',
    en: 'See the latest activity from the people you follow.',
  },
  feedFollowingRailLogin: {
    pt: 'Entre e siga jogadores para montar sua coluna de atividade.',
    en: 'Sign in and follow players to build your activity rail.',
  },
  feedFollowingRailEmpty: {
