...
export const GoogleIcon = ({ size = 16, className = '' }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" className={className} aria-hidden="true">
    <path fill="#4285F4" d="M21.35 12.27c0-.74-.07-1.45-.21-2.13H12v4.03h5.24a4.48 4.48 0 0 1-1.94 2.94v2.45h3.14c1.84-1.69 2.91-4.18 2.91-7.29Z" />
    <path fill="#34A853" d="M12 21.8c2.63 0 4.84-.87 6.45-2.34l-3.14-2.45c-.87.58-1.98.92-3.31.92-2.54 0-4.7-1.72-5.47-4.03H3.28v2.53A9.74 9.74 0 0 0 12 21.8Z" />
    <path fill="#FBBC05" d="M6.53 13.9a5.86 5.86 0 0 1 0-3.8V7.57H3.28a9.8 9.8 0 0 0 0 8.86l3.25-2.53Z" />
    <path fill="#EA4335" d="M12 6.07c1.43 0 2.71.49 3.72 1.45l2.79-2.79C16.83 3.18 14.63 2.2 12 2.2a9.74 9.74 0 0 0-8.72 5.37l3.25 2.53C7.3 7.79 9.46 6.07 12 6.07Z" />
  </svg>
)
