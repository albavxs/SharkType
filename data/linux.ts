...
cut -d: -f1 /etc/passwd | sort | uniq`,
  },
  {
    ...
    difficulty: 'hard',
    prompt: {
      pt: 'Descobre quais IPs deram mais erro no log e lista os diretórios que mais tão ocupando espaço.',
...
du -sh */ | sort -rh | head -10`,
  },
  {
    ...
    difficulty: 'medium',
    prompt: {
      pt: 'Sobe o nginx, habilita no boot, confere o status, restarta e fica acompanhando os logs.',
...
sudo journalctl -u nginx -f`,
  },
  {
    ...
    difficulty: 'easy',
    prompt: {
      pt: 'Exporta uma variável de banco, mostra o PATH, filtra as variáveis do Node e recarrega o bashrc.',
...
source ~/.bashrc`,
  },
  {
    ...
    difficulty: 'medium',
    prompt: {
      pt: 'Edita a crontab e agenda um backup diário às 2h da manhã e um healthcheck a cada 5 minutos.',
...
*/5 * * * * /opt/scripts/healthcheck.sh`,
  },
  {
    ...
    difficulty: 'medium',
    prompt: {
      pt: 'Conecta via SSH por IP e por chave, copia uma pasta pro servidor e envia um arquivo usando chave .pem.',
...
scp -i key.pem file.txt ubuntu@ip:/home/ubuntu/`,
  },
  {
    ...
    difficulty: 'medium',
    prompt: {
      pt: 'Faz um GET simples, um POST com JSON e baixa um arquivo direto pela URL.',
...
curl -o arquivo.zip https://example.com/file.zip`,
  },
  {
    ...
    difficulty: 'easy',
    prompt: {
      pt: 'Confere o espaço em disco geral e do /home, vê a memória livre e descobre o tamanho dos logs.',
...
du -sh /var/log/*`,
  },
  {
    ...
    difficulty: 'medium',
    prompt: {
      pt: 'Busca erros no log, procura TODOs recursivamente no src, filtra warnings e remove as linhas de debug.',
